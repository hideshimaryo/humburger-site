          ...
          <div class="inner">
            <ul class="l-contents__brunch-menu">
              <li class="p-take-out p-contents-parts">
                <h2 class="c-content-title"><a href="<?php echo get_category_link(get_cat_ID('Take Out')); ?>">Take OUT</a></h2>
              ...
              <li class="p-eat-in p-contents-parts">
                <h2 class="c-content-title"><a href="<?php echo get_category_link(get_cat_ID('Eat In')); ?>">Eat-In</a></h2>
                <div class="p-text-box">
                  <dl class="c-content_bg">
